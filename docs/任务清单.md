...
3.2.2 [创建Dashboard页面]
- 文件：frontend/src/pages/admin/Dashboard.vue
- 功能：
  - 数据统计卡片(用户数、笔记数、收入)
  - 图表展示(注册趋势、收入趋势)
  - 待处理任务提醒
...
3.2.4 [创建PDF校对器页面]
- 文件：frontend/src/pages/admin/Proofreader.vue
...
3.2.5 [创建笔记审核页面]
- 文件：frontend/src/pages/admin/NoteReview.vue
...
- 文件：backend/app/prompts/note_prompts.py
